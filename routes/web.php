...
Route::prefix('siswa')->middleware('auth:siswa')->group(function (){
    ...
    Route::post('/borrow/{id}', [LibraryController::class, 'borrowBook'])->name('borrow.book');
    Route::post('/pinjam/{buku}', [PeminjamanController::class, 'pinjam'])->name('pinjam');
    Route::post('/kembalikan/{buku}', [PeminjamanController::class, 'kembalikan'])->name('kembalikan');
